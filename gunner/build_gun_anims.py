...
CFG = dict(
    ...
    shoulder_y=40.0,
    grip_dist=340.0,          # 肩 -> 握把（应小于 上臂+前臂 之和）
    grip_r_off=(-12.0, -34.0),  # 右手握点（枪局部）
    grip_l_off=(96.0, -28.0),   # 左手握点（枪局部）
    muzzle=(252.0, 4.0),        # 枪口（枪局部）
    gun_w=300.0, gun_h=112.0,   # 枪附件尺寸
    gun_at_x=112.0, gun_at_y=-4.0,
